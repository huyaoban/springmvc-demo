...
import com.huyaoban.springmvc.config.Constants;
import com.huyaoban.springmvc.config.Result;
import com.huyaoban.springmvc.config.UserVo;
...
public class SpittleController {
	...
	public Result<UserVo> add(
		...
		return new Result<UserVo>(Constants.SUCCESS, Constants.MSG_SUCCESS,
				new UserVo());
	}
